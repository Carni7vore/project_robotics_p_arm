...
%         [res1,obj1]= vrep.simxGetObjectHandle(clientID,'P_Arm_joint1',vrep.simx_opmode_blocking);
    ...
    while  distance>1.3
                  theta=[(0)*pi;(80/180)*pi;(0/180)*pi;0;(0/180)*pi;(0/180)*pi];
...
%         [res1,obj1]= vrep.simxGetObjectHandle(clientID,'P_Arm_joint1',vrep.simx_opmode_blocking);
        ...
        [res6,obj6]= vrep.simxGetObjectHandle(clientID,'P_Arm_joint6',opMode);
              ...
              theta=[(0/180)*pi;(40/180)*pi;(0/180)*pi;0;(0/180)*pi;(0/180)*pi];
...
%         [res1,obj1]= vrep.simxGetObjectHandle(clientID,'P_Arm_joint1',vrep.simx_opmode_blocking);
 ...
 theta=[(0)*pi;(0/180)*pi;(0/180)*pi;0;(0/180)*pi;(0/180)*pi];
        ...
        pause(5);
   while  distance>0
                  theta=[(0)*pi;(75/180)*pi;(30/180)*pi;0;(20/180)*pi;(0/180)*pi];
...
%         [res1,obj1]= vrep.simxGetObjectHandle(clientID,'P_Arm_joint1',vrep.simx_opmode_blocking);
        ...
        [res6,obj6]= vrep.simxGetObjectHandle(clientID,'P_Arm_joint6',opMode);
              ...
              theta=[(0/180)*pi;(30/180)*pi;(0/180)*pi;0;(0/180)*pi;(0/180)*pi];
