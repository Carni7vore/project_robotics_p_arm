...
%     disp(theta);
%     for k=1:30
%    res=vrep.simxSetJointTargetPosition(clientID,obj1,theta0(1,k), vrep.simx_opmode_blocking);   
%     res=vrep.simxSetJointTargetPosition(clientID,obj2,theta0(2,k), vrep.simx_opmode_blocking);   
%     res=vrep.simxSetJointTargetPosition(clientID,obj3,theta0(3,k), vrep.simx_opmode_blocking);  
%     res=vrep.simxSetJointTargetPosition(clientID,obj4,theta0(4,k), vrep.simx_opmode_blocking);
%     res=vrep.simxSetJointTargetPosition(clientID,obj5,theta0(5,k), vrep.simx_opmode_blocking);
%     res=vrep.simxSetJointTargetPosition(clientID,obj6,theta0(6,k), vrep.simx_opmode_blocking);
%     pause(0.5);
%     end
